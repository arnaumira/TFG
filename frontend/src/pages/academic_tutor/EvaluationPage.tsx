...
import { getAcademicTutorStudents, getStudentEvaluations } from '../../api/academicTutor'
import type { StudentSummary } from '../../api/clinicalTutor'
import type { EvaluationDetail } from '../../api/evaluations'

export default function AcademicTutorEvaluationPage() {
  ...
  const handleSelectStudent = async (student: StudentSummary) => {
    ...
    getStudentEvaluations(student.assignmentId)
      .then(setEvaluations)
  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8]">
      <div className="max-w-md mx-auto px-5 pt-12 pb-28">
        ...
        <h1 className="text-xl font-semibold text-gray-900 mb-6">Avaluació</h1>

        {/* Selector d'estudiant */}
        <p className="text-sm font-medium text-gray-900 mb-3">Estudiants assignats</p>
        {loading ? (
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-xs text-gray-400">
                    {s.currentCourse ? `${s.currentCourse}r curs` : ''} · {s.area}
                  </p>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                  stroke={selectedStudent?.id === s.id ? '#0F6E56' : '#bbb'}
        ...
        {/* Avaluacions de l'estudiant seleccionat */}
        {selectedStudent && (
          <>
            <p className="text-sm font-medium text-gray-900 mb-3">
              Avaluacions de {selectedStudent.fullName}
            </p>
            ...
            {loadingEvals ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
                ...
                <p className="text-xs text-gray-400">El tutor clínic encara no ha avaluat aquest estudiant</p>
              </div>
            ) : (
