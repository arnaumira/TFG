...
import { getSessionsByMonth } from '../../api/clinicalTutor'
import QrModal from '../../components/QrModal'


type View = 'month' | 'week'

export default function ClinicalTutorCalendarPage() {
  ...
  useEffect(() => {
    ...
    getSessionsByMonth(year, month).then(data => {
      setSessions(data)
        ...
        {selectedSessions.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            <p className="text-sm text-gray-400 text-center">
              No hi ha sessions planificades per aquest dia
            </p>
          </div>
        ) : (
